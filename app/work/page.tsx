    ...
    <>
      ...
      <section className="wrap pb-6 pt-11">
        <div className="flex flex-col gap-[22px]">
          {WORK.map((w) => (
            <Link key={w.slug} href={`/work/${w.slug}`} className="surface grid grid-cols-1 items-center gap-6 overflow-hidden text-ink no-underline transition-colors hover:border-ink/30 md:grid-cols-[1fr_1.1fr] md:gap-9">
