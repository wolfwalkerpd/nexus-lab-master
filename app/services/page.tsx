...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://nexuslabsystems.com/services",
  },
};
        ...
        <div className="grid grid-cols-1 items-stretch gap-[22px] lg:grid-cols-3">
          {pillars.map((p, i) => (
            <FadeIn key={p.no} delay={i * 80}>
              <Link href={p.href} className="surface flex h-full flex-col p-6 text-ink no-underline transition-colors hover:border-ink/30 sm:p-8">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {also.map(([t, d], i) => (
            <FadeIn key={t} delay={i * 80}>
              <div className="h-full rounded-[13px] bg-panel px-[22px] py-6">
