...
{ q: "Who will I actually be dealing with?", a: "The people who actually design and build your site — never a salesperson who then hands you off. Whoever reviews your site is on the team that builds it and looks after it, so nothing gets passed to a junior or lost in a handoff to a stranger." },
  { q: "Why choose a small studio over a big agency?", a: "With a big agency you meet the salesperson, then your project goes to whoever's free — often someone you never speak to, and you become a ticket in a queue. With us you get a small, accountable team who know your name and your project, work done with genuine care, and none of the agency overhead padding your invoice." },
...
export const SITE_FAQS: SiteFaq[] = [
  ...
  { cat: "trust", q: "What if someone on the team is ill or unavailable?", a: "Because you own your site, domain and data outright, you're never dependent on any single person. We keep everything documented and backed up, so nothing hinges on one individual being reachable at a single moment. For anything urgent post-launch, care-plan clients get priority response." },
  ...
  { cat: "trust", q: "Do you work with businesses like mine?", a: "Most likely yes. We build for local and service-based businesses that win customers on trust — dentists, trades, professional services and similar. That's the same thing your customers judge when they land on your site, so it shapes everything we build." },
